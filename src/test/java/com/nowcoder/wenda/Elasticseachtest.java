...
public class Elasticseachtest {
    ...
    public void testUpdate() {
        DiscussPost post = discussPostMapper.selectDiscussPostById(207);
...
//        discussPostRepository.deleteById(207);
...
//        elasticsearchTemplate.queryForPage(searchQuery, class,SearchResultMapper)
    ...
    @Test
    public void testSearchForTemplate() {
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery("互联网寒冬", "title", "content"))
                .withSort(SortBuilders.fieldSort("type").order(SortOrder.DESC))
                .withSort(SortBuilders.fieldSort("score").order(SortOrder.DESC))
        ...
        Page<DiscussPost> page = elasticsearchTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            ...
            @Override
            public <T> T mapSearchHit(SearchHit hit, Class<T> aClass) {
